...
public class Kyrgyz implements Test{

    private int[] allQuest = new int[]{R.drawable.kliq_1, R.drawable.kliq_2,R.drawable.kliq_3,R.drawable.kliq_4,R.drawable.kliq_5,R.drawable.kliq_6,R.drawable.kliq_7,
            R.drawable.kliq_8, R.drawable.liq_1,R.drawable.liq_2,R.drawable.liq_3,R.drawable.liq_4,R.drawable.liq_5,R.drawable.liq_6,R.drawable.liq_7,
    ...
    public Kyrgyz(){
        ...
        allAnswer = new String[]{"B","C","B","C","B","A","D","A",
                "D","A","D","B","C","B","A","C","B","C",
                "A","C","B","C","D","A","D","B","A","C",
                "B","C","A","C","D","B","D","A","B","C",
                "D","A","B","D","A","B","C","B","C","B",
   ...
   /* @Override
    public List<Integer> getQuestions(Integer size) {return Arrays.asList(allQuestK).subList(1,size);}


    @Override
    public List<String> getAnswers(Integer size) { return Arrays.asList(allAnswerK).subList(1,size);}
