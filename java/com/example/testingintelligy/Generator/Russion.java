...
public class Russion implements Test{
    ...
    private int[]  allImageAnswers = new int[]{R.drawable.liq_1_a,R.drawable.liq_2_a,R.drawable.liq_3_a,R.drawable.liq_4_a,R.drawable.liq_5_a,R.drawable.liq_6_a,R.drawable.liq_7_a,
    ...
    public Russion(){create();}
    private void  create(){
        allQuest = new int[]{R.drawable.rliq_1, R.drawable.rliq_2,R.drawable.rliq_3,R.drawable.rliq_4,R.drawable.rliq_5,R.drawable.rliq_6,R.drawable.rliq_7,
                R.drawable.rliq_8, R.drawable.liq_1,R.drawable.liq_2,R.drawable.liq_3,R.drawable.liq_4,R.drawable.liq_5,R.drawable.liq_6,R.drawable.liq_7,
        ...
        allAnswer = new String[]{"B","A","B","C","B","D","C","B",
                "D","A","D","B","C","B","A","C","B","C",
                "A","C","B","C","D","A","D","B","A","C",
                "B","C","A","C","D","B","D","A","B","C",
                "D","A","B","D","A","B","C","B","C","B",
   ...
   /* @Override
    public List<Integer> getQuestions(Integer size) {
        Integer[] q = Arrays.copyOfRange(allQuestR,1,size); return Arrays.asList(q);}

    @Override
    public List<String> getAnswers(Integer size) {return Arrays.asList(allAnswerR).subList(1,size);}

    @Override
    public  List<Integer> getImageAnswers(Integer size){return Arrays.asList(allImageAnswer).subList(1,size);}*/
   @Override
